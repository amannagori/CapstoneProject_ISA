<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAllItem.aspx.cs"
    MasterPageFile="~/Main.Master" Inherits="ISA_Project.AdminAllItem" %>
                                ...
                                <ItemTemplate>
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src='<%#Eval("itemImagePath") %>' height="200" width="320" runat="server" /><br />
                                                    <br />
                                                    <b>Item Id : </b>
                                    ...
                                    <br />
                                                    ...
                                                    <br />
                                                    <b>Selling Price : </b>$
                                    <asp:Label ID="itemPrice" runat="server" Text='<%# Bind("itemPrice") %>'></asp:Label>
                                                    <br />
                                                    <b>Category: </b>
