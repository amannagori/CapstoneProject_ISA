<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" 
    MasterPageFile="~/Main.Master" CodeBehind="Event.aspx.cs" Inherits="ISA_Project.Event" %>
...
<asp:Content ContentPlaceHolderID="body" runat="server">
    <form id="form1">
        <div class="container">
            ...
            <div class="row">
                <div class="box">
                    ...
                    <hr>
                        <div>
                            <asp:Button ID="AddEventPageLink" class="btn btn-success " runat="server" Text="Add Event" OnClick="AddEventPageLink_Click" />
                        </div>
                        <br />
        ...
        <asp:Label ID="demoLbl" runat="server" Text=""></asp:Label>
    </form>
</asp:Content>
